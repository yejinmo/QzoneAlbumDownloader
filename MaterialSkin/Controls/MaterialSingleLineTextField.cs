...
namespace MaterialSkin.Controls
{
    public class MaterialSingleLineTextField : Control, IMaterialControl
    {
        ...
        private Color followLabelColor = Color.FromArgb(0, 0, 0);
        private Color followLabeloldColor = Color.FromArgb(200, 200, 200);
        public Color FollowLabelColor { get { return followLabelColor; } set { followLabelColor = value; } }
        public Color FollowLabeloldColor { get { return followLabeloldColor; } set { followLabeloldColor = value; } }
        private Color oldForeColor;
        private bool onError = false;
        [Browsable(false)]
        private bool isErrorMode = false;
        public bool IsErrorMode { get { return isErrorMode; } set { isErrorMode = value; } }
        private Color errorModeColor = Color.Red;
        public Color ErrorModeColor { get { return errorModeColor; } set { errorModeColor = value; } }
        private string errorModeString = "";
        private string oldLabelString;
        public string ErrorModeString { get { return errorModeString; } set { errorModeString = value; } }

        //public new Color ForeColor { get { return baseTextBox.ForeColor; } set { baseTextBox.ForeColor = value; } }
        ...
        public MaterialSingleLineTextField()
        {
            ...
            MouseEnter += new EventHandler(TextMouseEnter);
            MouseLeave += new EventHandler(TextMouseLeave);
            LostFocus += MaterialSingleLineTextField_LostFocus;
            MouseMove += MaterialSingleLineTextField_MouseMove;
            TextChanged += MaterialSingleLineTextField_TextChanged;
            GotFocus += MaterialSingleLineTextField_GotFocus;
            //Fix for tabstop
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            {
                //No animation
                g.FillRectangle(baseTextBox.Focused ? SkinManager.ColorScheme.PrimaryBrush : new SolidBrush(Color.FromArgb(40, 40, 40)), baseTextBox.Location.X, lineY, baseTextBox.Width, baseTextBox.Focused ? 2 : 1);
            }
            else
            {
                //Animate
        ...
        private void TextMouseEnter(object sender, System.EventArgs e)
        {
        ...
        private void TextMouseLeave(object sender, System.EventArgs e)
        {
            if (followLabel == null || onError)
                return;
        ...
        private void MaterialSingleLineTextField_MouseMove(object sender, MouseEventArgs e)
        {
            if (followLabel == null || followLabel.ForeColor == followLabelColor || onError)
                return;
            followLabel.ForeColor = followLabelColor;
        }

        public void OnError(bool IsError = true)
        {
            if (IsErrorMode)
                if (IsError)
                {
                    if (followLabel != null)
                    {
                        ...
                        oldLabelString = followLabel.Text;
                        followLabel.Text = errorModeString;
                        followLabel.ForeColor = errorModeColor;
                    }
                    oldForeColor = baseTextBox.ForeColor;
                    baseTextBox.ForeColor = errorModeColor;
                    onError = true;
                }
                else
                {
                    if (followLabel != null)
                    {
                        followLabel.Text = oldLabelString;
                        if (baseTextBox.Focused)
                            followLabel.ForeColor = followLabelColor;
                        else
                            followLabel.ForeColor = followLabeloldColor;
                    }
                    baseTextBox.ForeColor = oldForeColor;
                    onError = false;
                }
        }

        private void MaterialSingleLineTextField_TextChanged(object sender, EventArgs e)
        {
            if (IsErrorMode && onError)
                OnError(false);
        }
