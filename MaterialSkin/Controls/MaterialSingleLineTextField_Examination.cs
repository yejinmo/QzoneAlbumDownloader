...
{
    public class MaterialSingleLineTextField_Examination : Control, IMaterialControl
    {
        ...
        private MaterialLabel_Examination bindingLabel = null;
        public MaterialLabel_Examination BindingLabel
        {
            get
            {
                return bindingLabel;
