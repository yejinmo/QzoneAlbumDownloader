...
namespace MaterialSkin.Controls
{
    public class MaterialRadioButton : RadioButton, IMaterialControl
    {
        ...
        {
            int width = boxOffset + 20 + (int)CreateGraphics().MeasureString(Text, SkinManager.FONT_SIZE_18).Width;
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            SizeF stringSize = g.MeasureString(Text, SkinManager.FONT_SIZE_18);
            g.DrawString(Text, SkinManager.FONT_SIZE_18, Enabled ? SkinManager.GetPrimaryTextBrush() : SkinManager.GetDisabledOrHintBrush(), boxOffset + 22, Height / 2 - stringSize.Height / 2);
